"""
Модульные тесты для проверки функций расчета учебной нагрузки (Pytest).
"""
...
def test_check_workload_compliance_within_tolerance():
    """Проверка отклонения в пределах допустимой погрешности (±10 ч)."""
...
def test_check_workload_compliance_overload():
    """Проверка фиксации перегрузки сверх допустимой погрешности."""
...
def test_check_workload_compliance_underload():
    """Проверка фиксации недогрузки сверх допустимой погрешности."""
...
def test_calculate_actual_rate():
    """Проверка расчета доли ставки преподавателя."""
    # Полная ставка
